...
A community-driven, open-source platform for preserving and bridging the **Sylheti regional dialect** and **standard Bengali**. Users contribute word pairs, and together we build a growing linguistic database that anyone can search and use.
...
[![Open Source](https://img.shields.io/badge/Open%20Source-contributions%20welcome-orange?style=flat-square)](https://github.com/kamilhussen24/sylheti-translator)

---

## What Is This?

This is **not** a traditional AI translator. Machine learning models are not yet well-trained on Sylheti, and building a reliable one requires a large dataset that is still being built.
...
4. Over time, the database grows into a proper linguistic resource for training a real Sylheti language model
...
- **Android app** — built with the Median framework (WebView wrapper)
...
## AI Model (Early Stage)

We have begun training a dedicated Sylheti language model based on **MBart**:

[![Sylheti-MBart on Hugging Face](https://img.shields.io/badge/HuggingFace-Sylheti--MBart-yellow?style=flat-square&logo=huggingface)](https://huggingface.co/kamilhussen24/Sylheti-MBart)

The model is in early training — the dataset is currently too small to produce reliable results. As the community database grows through word submissions on this platform, the model will be retrained with richer data. The long-term goal is to replace the lookup-based translator with a proper neural translation model that understands Sylheti naturally.
...
This project is **open source** — contributions of any kind are welcome. Whether you want to fix a bug, improve the UI, add a blog post, or help with the AI model, you're encouraged to get involved.
...
If you're unsure where to start, open an [issue](https://github.com/kamilhussen24/sylheti-translator/issues) and describe what you'd like to work on.
...
| AI Model | MBart fine-tuned on Sylheti (early stage) |
...
The sitemap is automatically regenerated by a GitHub Actions workflow every Friday.
...
- [x] Blog section
- [x] Early AI model (Sylheti-MBart, Hugging Face)
- [ ] Word history and edit log
- [ ] User accounts
- [ ] Grow dataset and retrain AI model for production use
